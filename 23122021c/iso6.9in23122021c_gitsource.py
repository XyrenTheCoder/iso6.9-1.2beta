...
async def on_ready():
    ...
    print(f'[{current_time} log] {bot.user} changed its activity.')
...
async def on_command_error(ctx, error):
    if isinstance(error, commands.MissingRequiredArgument):
        ...
        print(f'[{current_time} log] {ctx.author} returned an error: {error}.')
...
async def embed(ctx):
    ...
    embed.add_field(name='informative:', value="testcmd, ping, serverlist, morebots, serverinfo, userinfo, invites", inline=False)
    ...
    print(f'[{current_time} log] {ctx.author} requested ]help.')
...
async def embed77(ctx):
    ...
    embed.add_field(name='informative:', value="test, ping, slist, bots, sinfo, whoami, invites", inline=False)
    ...
    await ctx.reply(embed=embed)
    print(f'[{current_time} log] {ctx.author} requested ]ahelp.')
...
async def on_message(message):
    ...
    if message.content.startswith("sudo help") and not message.author.bot:
        if message.author.id in oid:
            ...
            print(f'[{current_time} log] Beware! Non-admin using sudo command detected. Requested by: {message.author.name}')
...
async def testcmd(ctx):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]test.')
...
async def roll(ctx, number_of_dice: int, number_of_sides: int):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]roll.')
...
async def _8ball(ctx, *, question):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]8ball.')

@bot.command()
@commands.cooldown(1, 5, commands.BucketType.user)
async def ping(ctx):
    await ctx.send(f'Client Latency: {round(bot.latency * 1000)}ms')
    print(f'[{current_time} log] {ctx.author} requested ]ping.')
...
async def fstab(ctx):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]fstab.')
...
async def embed_2(ctx):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]serverlist.')
...
async def embed_3(ctx):
    ...
    await ctx.send(embed=embed)
    print(f'[{current_time} log] {ctx.author} requested ]morebots.')
...
async def say(ctx, *, text):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]say, content: {ctx.message_content}.')
...
async def null_1(ctx):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]null.')
...
async def kick(ctx, member: discord.Member, *, reason=None):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]kick.')
...
async def clean(ctx, limit: int):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]purge.')
...
async def mute(ctx, member: discord.Member, *, reason=None):
    ...
    await ctx.send(embed=embed)
    print(f'[{current_time} log] {ctx.author} requested ]mute.')
    await member.add_roles(mutedRole, reason=reason)
    await member.send(f" you have been muted from: {guild.name}\n reason: {reason}")
    print(f'[{current_time} log] {ctx.author} \'s DM has successfully sent.')
...
async def unmute(ctx, member: discord.Member):
   ...
   await ctx.send(embed=embed)
   print(f'[{current_time} log] {ctx.author} requested ]unmute.')
...
async def ban(ctx, member : discord.Member, *, reason = None):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]ban.')
...
async def unban(ctx, id: int):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]unban.')
...
async def snipe(ctx):
    ...
    try:
        ...
        print(f'[{current_time} log] {ctx.author} requested ]snipe.')
    except:
        await ctx.send(f"There are no recently deleted messages in #{channel.name}")
        print(f'[{current_time} log] {ctx.author} returned an error: No recently deleted messages.')
# end of snipe
...
async def edit_snipe(ctx):
    try:
        ...
        await ctx.send(embed = em)
        print(f'[{current_time} log] {ctx.author} requested ]edit_snipe.')
    except:
        await ctx.reply('No recently edited messages here :eyes:')
        print(f'[{current_time} log] {ctx.author} returned an error: No recently edited messages.')
# end of edit_snipe
...
async def serverinfo(ctx):
    ...
    await ctx.send(embed=embed)
    print(f'[{current_time} log] {ctx.author} requested ]serverinfo.')
...
async def userinfo(ctx, *, member:discord.Member = None):
    ...
    await ctx.send(embed=embed)
    print(f'[{current_time} log] {ctx.author} requested ]userinfo.')
...
async def warn(ctx, user:discord.User = None, *, warn_reason=None):
    if user == None:
        ...
        print(f'[{current_time} log] {ctx.author} returned an error: No user mentioned.')
        return
    try:
        if warn_reason == None:
        ...
        print(f'[{current_time} log] {ctx.author} requested ]warn.')
    except:
        ...
        print(f'[{current_time} log] {ctx.author} returned an error: DM not opened.')
...
async def notify(ctx, user:discord.User = None, *, message):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]notify, content: {ctx.message_content}.')
...
async def isSus(ctx, *, user: discord.User):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]sus.')
...
async def lock(ctx, channel : discord.TextChannel=None):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]lock.')
...
async def unlock(ctx, channel : discord.TextChannel=None):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]unlock.')
...
async def stroke(ctx, size: int):
    ...
    if size > 550:
        ...
        print(f'[{current_time} log] {ctx.author} returned an error: Max character limit reached.')
    else:
        await ctx.send(random_string_generator(size, chars))
        print(f'[{current_time} log] {ctx.author} requested ]stroke.')
...
async def sum(ctx, num1: float, num2: float):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]sum.')

@bot.command(aliases=['-'])
async def subtract(ctx, num1: float, num2:float):
    ans = str(num1 - num2)
    await ctx.send(f'`{num1} - {num2}` = __{ans}__\n\n--end of calculation--')
    print(f'[{current_time} log] {ctx.author} requested ]subtract.')

@bot.command(aliases=['*'])
async def multiply(ctx, num1: float, num2: float):
    ans = str(num1 * num2)
    await ctx.send(f'`{num1} × {num2}` = __{ans}__\n\n--end of calculation--')
    print(f'[{current_time} log] {ctx.author} requested ]multiply.')

@bot.command(aliases=['/'])
async def divide(ctx, num1: float, num2: float):
    if num2 == 0:
        await ctx.send("math error: it can\'t be divided by zero.")
        print(f'[{current_time} log] {ctx.author} returned an math error: Divide by zero.')
        return
    ans = str(num1 / num2)
    await ctx.send(f'`{num1} ÷ {num2}` = __{ans}__\n\n--end of calculation--')
    print(f'[{current_time} log] {ctx.author} requested ]divide.')

@bot.command(aliases=['**'])
async def power(ctx, num1: float, num2: int):
    ans = str(num1 ** num2)
    await ctx.send(f'`{num1} ^ {num2}` = __{ans}__\n\n--end of calculation--')
    print(f'[{current_time} log] {ctx.author} requested ]power.')

@bot.command(aliases=['sqrt'])
async def squareroot(ctx, num: float):
    ans = cmath.sqrt(num)
    await ctx.send(f'`√ {num}` = __{ans}__\n\n--end of calculation--')
    print(f'[{current_time} log] {ctx.author} requested ]squareroot.')
...
async def quadratic(ctx, a: float, b: float, c: float):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]quadratic.')
...
async def straightline(ctx, A: float, B: float, C: float):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]straightline.')
# end of maths
...
async def randnum(ctx, range1: int, range2: int):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]randnum.') 
...
async def guess(ctx, num: int):
    ...
    print(f'[{current_time} log] {ctx.author} requested ]guess.')
...
async def duel(ctx, player2: discord.User):
    if ctx.author == player2:
        ...
        print(f'[{current_time} log] {ctx.author} returned an error: Bad argument.')
...
#
    ...
    if hplast1 < 0 and hplast2 < 0:
        return await ctx.send(f"{ctx.author} and {player2} both died, LOL.")
    else:
        await ctx.send(f'{ctx.author}\'s hp: {hplast1}\n{player2}\'s hp: {hplast2}\n\n{winner} won!')
    print(f'[{current_time} log] {ctx.author} requested ]duel with {player2}')
# end of duel
